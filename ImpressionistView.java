...
public class ImpressionistView extends View {
    ...
    private Path    mPath;
    private boolean inverse_color = false;
        ...
        switch(motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                for (int i = 0; i < historySize; i++) {
                    ...
                    int pix = imageViewBitmap.getPixel((int)curtouchX, (int)curtouchY);

                    if (inverse_color == true) {
                        _paint.setARGB(255, (255 - Color.red(pix)),
                                (255 - Color.green(pix)),
                                (255 - Color.blue(pix)));
                        //_paint.setARGB(255, 255, 0, 0);
                    }
                    else
                        _paint.setARGB(255, Color.red(pix),Color.green(pix),Color.blue(pix));
                    ...
                    if(_brushType == BrushType.Circle){
                        ...
                        _offScreenCanvas.drawRect(touchX,touchY,curtouchX, curtouchY,_paint);
                    }else if(_brushType == BrushType.Line) {
                        _paint.setStrokeWidth(50);
                        _offScreenCanvas.drawLine(touchX,touchY,curtouchX,curtouchY,_paint);
                    }
    ...
    private static Rect getBitmapPositionInsideImageView(ImageView imageView){
        ...
        http://www.fifa.com/fifa-tournaments/archive/worldcup/
